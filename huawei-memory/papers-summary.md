...
![A-MEM架构图](images/a-mem/img-028.png)

*图：A-MEM 完整架构，包含 Note Construction、Link Generation、Memory Evolution、Memory Retrieval*
...
![NEMORI框架图](images/nemori/)

*注：NEMORI PDF 使用矢量图形，pdfimages 未能提取到栅格化图片。框架包含 Episodic Memory Integration（上）和 Semantic Knowledge Distillation（下）两个级联模块。*
